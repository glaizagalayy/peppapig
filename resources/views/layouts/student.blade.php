  ...
  <nav id="sidebar" class="collapse d-md-block bg-white text-black sidebar" style="z-index: 999;">
    <div class="position-sticky pt-3">
      ...
      <ul class="nav flex-column mt-2">
        ...
        <li class="nav-item">
          <a href="{{ route('student.studentUpload') }}" class="nav-link @if(request()->routeIs('student.studentUpload')) active @endif">
            <i class="fas fa-credit-card me-2"></i>
            Proof of Payment
          </a>
        </li>
    ...
    <header class="header shadow-sm p-3" style="background-color: #22BBEA;">
      <div class="container-fluid d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
          ...
          <h1 class="title h4 mb-0">@yield('page-title', 'Student Dashboard')</h1>
        </div>
        <div class="dropdown">
...
<script src="{{ asset('js/studentSidebar.js') }}"></script>
@stack('scripts')
